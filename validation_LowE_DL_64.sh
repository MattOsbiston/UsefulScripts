xml=$MY_TEST_AREA/LArReco/settings/PandoraSettings_Master_DUNEFD_VD_LowE_DL_64.xml
...
for i in {5..30}; do
        ...
        mv hierarchy_validation_LowE_DL.root hierarchy_validation_LowE_DL_64_${i}.root
        mv vertices_LowE_DL.root vertices_LowE_DL_64_${i}.root
done
