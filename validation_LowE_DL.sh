...
for i in {5..30}; do
        ...
        mv hierarchy_validation_LowE_DL.root hierarchy_validation_LowE_improved_cheatpfo_2_2500_${i}.root
        mv vertices_LowE_DL.root vertices_LowE_improved_cheatpfo_2500_${i}.root
done
