xml=$MY_TEST_AREA/LArReco/settings/PandoraSettings_Master_DUNEFD_VD_LowE_DL_v5.xml
...
for i in {5..30}; do
        ...
        mv hierarchy_validation_LowE_DL_v5.root hierarchy_validation_LowE_DL_Pass1_v5_${i}.root
        mv vertices_LowE_DL_v5.root vertices_LowE_DL_Pass1_v5_${i}.root
done
