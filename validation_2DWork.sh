xml=$MY_TEST_AREA/LArReco/settings/PandoraSettings_Master_DUNEFD_VD_LowE_DL_2DWork.xml
...
for i in {5..30}; do
        ...
        mv hierarchy_validation_2DWork.root hierarchy_validation_2DWorkv2_${i}.root
        mv vertices_2DWork.root vertices_2DWork__${i}.root
done
